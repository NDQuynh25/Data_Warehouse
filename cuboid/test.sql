...
BEGIN
    ...
    -- 11. Bảng tổng hợp theo Time(Year, Quarter, Month) + Product + Customer(CustomerKey) + Location(State)
    IF OBJECT_ID('Sales_4D_Year_Quarter_Month_Product_CustomerKey_Location', 'U') IS NOT NULL
        DROP TABLE Sales_4D_Year_Quarter_Month_Product_CustomerKey_Location;
    SELECT
        Year,
        Quarter,
        Month,
        ...
        SUM(Quantity_Sold) AS Quantity_Sold,
        SUM(Revenue) AS Revenue
    INTO Sales_4D_Year_Quarter_Month_Product_CustomerKey_Location
    FROM Sales_Source_Data
    GROUP BY 
        Year, Quarter, Month,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        Location_Key, State, City;
    -- 12. Bảng tổng hợp theo Time(Year, Quarter) + Product + Customer(CustomerKey) + Location(State)
    IF OBJECT_ID('Sales_4D_Year_Quarter_Product_CustomerKey_Location', 'U') IS NOT NULL
        DROP TABLE Sales_4D_Year_Quarter_Product_CustomerKey_Location;
    SELECT
        Year,
        Quarter,
        Product_Key, Description,
        ...
        SUM(Quantity_Sold) AS Quantity_Sold,
        SUM(Revenue) AS Revenue
    INTO Sales_4D_Year_Quarter_Product_CustomerKey_Location
    FROM Sales_4D_Year_Quarter_Month_Product_CustomerKey_Location
    GROUP BY 
        Year, Quarter,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        Location_Key, State, City;
    -- 13. Bảng tổng hợp theo Time(Year) + Product + Customer(CustomerKey) + Location(State)
    IF OBJECT_ID('Sales_4D_Year_Product_CustomerKey_Location', 'U') IS NOT NULL
        DROP TABLE Sales_4D_Year_Product_CustomerKey_Location;
    SELECT
        Year,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        ...
        SUM(Quantity_Sold) AS Quantity_Sold,
        SUM(Revenue) AS Revenue
    INTO Sales_4D_Year_Product_CustomerKey_Location
    FROM Sales_4D_Year_Quarter_Product_CustomerKey_Location
    GROUP BY 
        Year,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        Location_Key, State, City;
    -- 14. Bảng tổng hợp theo Time(Quarter) + Product + Customer(CustomerKey) + Location(State)
    IF OBJECT_ID('Sales_4D_Quarter_Product_CustomerKey_Location', 'U') IS NOT NULL
        DROP TABLE Sales_4D_Quarter_Product_CustomerKey_Location;
    SELECT
        Quarter,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        ...
        SUM(Quantity_Sold) AS Quantity_Sold,
        SUM(Revenue) AS Revenue
    INTO Sales_4D_Quarter_Product_CustomerKey_Location
    FROM Sales_4D_Year_Quarter_Product_CustomerKey_Location
    GROUP BY 
        Quarter,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        Location_Key, State, City;
    -- 15. Bảng tổng hợp theo Time(Month) + Product + Customer(CustomerKey) + Location(State)
    IF OBJECT_ID('Sales_4D_Month_Product_CustomerKey_Location', 'U') IS NOT NULL
        DROP TABLE Sales_4D_Month_Product_CustomerKey_Location;
    SELECT
        Month,
        Product_Key, Description,
        Customer_Key, Customer_Name, Customer_Type,
        ...
        SUM(Quantity_Sold) AS Quantity_Sold,
        SUM(Revenue) AS Revenue
    INTO Sales_4D_Month_Product_CustomerKey_Location
    FROM Sales_4D_Year_Quarter_Month_Product_CustomerKey_Location
    GROUP BY 
        Month,
        Product_Key, Description,
